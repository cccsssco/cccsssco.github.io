...
function conversion() {
  ...
  if(conversionOptions.value == "volume"){
    ...
    if(inputOptions.value == 'cubicFoot' && outputOptions.value == 'milliliters' ){
      output.value = multiply(input,28316.8466);
    }
    if(inputOptions.value == 'milliliters' && outputOptions.value == 'cubicFoot' ){
      output.value = divide(input,28316.8466);
    }
    if(inputOptions.value == 'cubicFoot' && outputOptions.value == 'cubicMeters' ){
      output.value = multiply(input,0.02831685);
    }
    if(inputOptions.value == 'cubicMeters' && outputOptions.value == 'cubicFoot' ){
    ...
    if(inputOptions.value == 'cubicInch' && outputOptions.value == 'milliliters' ){
      output.value = multiply(input,16.387064069264);
    }
    if(inputOptions.value == 'milliliters' && outputOptions.value == 'cubicInch' ){
    ...
    if(inputOptions.value == 'cubicInch' && outputOptions.value == 'cubicFoot' ){
      output.value = divide(input,1728);
    }
    if(inputOptions.value == 'cubicFoot' && outputOptions.value == 'cubicInch' ){
