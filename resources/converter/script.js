...
function conversion() {
  ...
  if (conversionOptions.value == "measurement") {
    ...
    if (
      inputOptions.value == "nauticalMile" &&
      outputOptions.value == "nanometers"
    ) {
    ...
    if (
      inputOptions.value == "nanometers" &&
      outputOptions.value == "nauticalMile"
    ) {
    ...
    if (
      ...
      output.value = dividedByTenThousand(
        mileToNauticalMile(mileToYard(input))
      );
    }
    if (
      inputOptions.value == "nauticalMile" &&
    ...
    if (
      ...
      output.value = timesHundredThousand(
        centimeterToMile(mileToNauticalMile(input))
      );
    }
  }
  if (conversionOptions.value == "mass") {
    ...
    if (
      inputOptions.value == "microgram" &&
      outputOptions.value == "milligram"
    ) {
      output.value = dividedByThousand(input);
    }
    if (
      inputOptions.value == "milligram" &&
      outputOptions.value == "microgram"
    ) {
      output.value = timesThousand(input);
    }
    ...
    if (
      inputOptions.value == "microgram" &&
      outputOptions.value == "kilogram"
    ) {
      output.value = dividedBy1e9(input);
    }
    if (
      inputOptions.value == "kilogram" &&
      outputOptions.value == "microgram"
    ) {
      output.value = times1e9(input);
    }
    ...
    if (
      inputOptions.value == "imperialTon" &&
      outputOptions.value == "microgram"
    ) {
    ...
    if (
      inputOptions.value == "microgram" &&
      outputOptions.value == "imperialTon"
    ) {
...
function imperialTonToGram(imperialTon) {
  return 1016046.91 * imperialTon;
}
function gramToImperialTon(gram) {
  return gram / 1016046.91;
}
function usTonToGram(usTon) {
  return 907184.74 * usTon;
}
function gramToUSTon(gram) {
  return gram / 907184.74;
}
function stoneToGram(stone) {
  return 6350.29318 * stone;
}
function gramToStone(gram) {
  return gram / 6350.29318;
}
