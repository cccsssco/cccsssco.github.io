...
function areaCircle() {
  ...
  document.getElementById("aoac-output").placeholder =
    Math.PI * radius ** 2 +
    " |or| " +
    Math.round((Math.PI * radius ** 2 + Number.EPSILON) * 100) / 100;
}
function perimeterCircle() {
  let radius = document.getElementById("poac-input").value;
  document.getElementById("poac-output").placeholder =
    Math.PI * (radius * 2) +
    " |or| " +
    Math.round((Math.PI * (radius * 2) + Number.EPSILON) * 100) / 100;
}
...
function pythagorean() {
  let a = document.getElementById("pt-input-x").value;
  let b = document.getElementById("pt-input-y").value;
  let c = document.getElementById("pt-input-z").value;
  if (c == '') {
    document.getElementById("pt-input-z").value = Math.sqrt(a ** 2 + b ** 2);
  }
  if (a == '') {
    document.getElementById("pt-input-x").value = Math.sqrt(c ** 2 - b ** 2);
  }
  if (b == '') {
    document.getElementById("pt-input-y").value = Math.sqrt(c ** 2 - a ** 2);
  }
  console.log("hello!");
}
